 ...
 */
// Modification: K must be comparable in order for entrySet to return in natural order
public class LinHashMap <K extends java.lang.Comparable<? super K>, V>
       ...
       implements Serializable, Cloneable, Map <K, V>
{
    ...
    /**
     * Class that compares AbstractMap#SimpleEntry by keys
     * needed for entrySet method to be in natural order
     * @author 
     */

    class KeyComparator<Key extends Comparable<? super Key>,Val> implements Comparator<Map.Entry<K, V>> {
        /**
         * Custom comparator for the simpleentries to be stored in the set.
         * @param one First entry to compare.
         * @param two Second entry to compare.
         * @author
         */
        @Override
        public int compare(Map.Entry<K, V> one,
                        Map.Entry<K, V> two)
        {
    ...
    {
        return java.lang.Math.floorMod(key.hashCode(), mod1);
    } // h
    ...
    {
        return java.lang.Math.floorMod(key.hashCode(), mod2);
    } // h2
