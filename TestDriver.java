...
class TestDriver
{
    ...
    public static void main (String [] args)
    {
        ...
        Table test = new Table ("test", "roll_no name", "Integer String", "roll_no");
        Table test2 = new Table ("test2", "roll_no marks", "Integer Integer", "roll_no");

        Comparable [] stud0 = {1, "A"};
        Comparable [] stud1 = {2, "B"};
        Comparable [] stud2 = {3, "C"};

        Comparable [] stud3 = {2, 70};
        Comparable [] stud4 = {3, 50};
        Comparable [] stud5 = {4, 80};
        ...
        test.print();
        test2.print();
        Table n = test.indexJoin("roll_no", "roll_no", test2);
        n.print();
