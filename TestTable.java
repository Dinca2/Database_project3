...
class TestTable
{
    ...
    public static void main (String [] args)
    {
        ...
        var test1 = new TupleGeneratorImpl ();

        test1.addRelSchema ("Student",
                            "id name address status",
                            "Integer String String String",
                            "id",
                          null);
                
        test1.addRelSchema ("Professor",
                            "id name deptId",
                            "Integer String String",
                            "id",
                            null);
                
        test1.addRelSchema ("Course",
                            "crsCode deptId crsName descr",
                            "String String String String",
                            "crsCode",
                            null);
                
        test1.addRelSchema ("Teaching",
                            "crsCode semester profId",
                            "String String Integer",
                            "crcCode semester",
                            new String [][] {{ "profId", "Professor", "id" },
        ...
        /* var tups = new int [] { 5000, 100, 100, 100, 100 };
        ...
        /*var tups2 = new int [] { 10000,  100, 100, 100, 100};
        ...
        var tups3 = new int [] { 15000,  100, 100, 100, 100 };
        ...
        var tups4 = new int [] { 20000,  100, 100, 100, 100 };
